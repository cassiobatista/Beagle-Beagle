...
% [IEEE'13] Designing Android Applications Using Voice Controlled Commands: For Hands Free Interaction with Common Household Devices
...
Como o iOS e o Android foram lançados, respectivamente, em 2007 e 2008, e sendo 
...
Em~\cite{ieee11}, o decodificador PocketSphinx foi
...
serem escolhidas. Diversos tutoriais de comparação entre as plataformas estão
disponíveis na Internet~\cite{mhl,randomnerd,makezine}.
...
simples, recomendada para projetos de menor porte. O microcontrolador pode ser
...
possível conectar-se à Internet através de um conector Ethernet. Sendo
