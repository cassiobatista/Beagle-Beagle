...
televisivos, e guardado a informação recebida no banco de dados. Toda a
informação de saída a ser enviada como comando para os leds infravermelhos deve
ser oriunda do banco de dados. Além disso, bibliotecas que permitem o acesso ao
MySQL por códigos em C serão instaladas, já que essa é a principal linguagem do
...
``mudar para o canal 18'', por exemplo. Além disso, como mencionado na subseção
anterior, um módulo receptor também será adicionado na BeagleBone para que ela
seja capaz de captar informações de outros controles remotos e, assim,
