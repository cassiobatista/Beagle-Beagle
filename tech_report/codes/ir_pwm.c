...
int main() {
	...
	unsigned short int a[] = { 
			...
			320, 520, 760, 960, 340, 520, 760, 520, 320, 960, 320, 540, 320, 960,
	...
	unsigned short int b[] = { 
			...
			320, 540, 740, 960, 340, 520, 760, 520, 320, 960, 760, 960, 16164, 2480,
	...
	unsigned short int c[] = { 
			...
			540, 320, 960, 15704, 2480, 960, 320, 960, 340, 520, 320, 520, 1200,
	...
	unsigned short int d[] = { 
			...
			540, 320, 960, 15704, 2500, 940, 320, 960, 320, 540, 320, 540, 1180,
	...
	unsigned short int e[] = { 
			...
			540, 320, 520, 340, 520, 760, 960, 320, 520, 340, 520, 760, 960, 16144,
...
char *decode(short int *dur, uint8_t size)
{
	...
	for(i=1,j=0; i<size; i++) {
		...
		if((dur[i]+dur[i+1])>=(360+560)) {
			if((high==1) && (dur[i+1]>(560))) {
				high = 0;
				stay = 1;
				bitstream[j++] = '1';
			}

			else if((high==1) && (dur[i+1]<=(560))) {
				stay = 0;
				high = 1;
				bitstream[j++] = '1';
			}

			else if((high==0) && (dur[i+1]>(360))) {
				high = 1;
				stay = 1;
				bitstream[j++] = '0';
			}
...
{
/* t = 16 * (1/36) */
/* duration = sum([6*t 2*t 2*t 2*t 20*t 20*t])*/
