...
\section{Teoria}
\subsection{Teoria}
\begin{frame}{O que é BeagleBone Black?}
\begin{figure}
...
\section{Work}
\subsection{Work}
\begin{frame}{Códigos, Falhas, Dificuldades...}
\begin{figure}
...
\begin{itemize}
	\item Atribuir valores a arquivos é lento demais no ARM
	\item Simulação GPIO no core i7: média de 10~$\mu$s 
\end{itemize}
\begin{figure}
...
\begin{frame}{Códigos}
\begin{itemize}
	\item Protocolo de Comunicação BBB $\rightarrow$ UNO: \smallskip
	\begin{itemize}
