...
\begin{table}[!h]
	...
	& Projeto apresentado à disciplina Projetos de Hardware e Interfaceamento 
...
%	\item[FISL] Fórum Internacional de Software Livre
%	\item[HMM] \textit{Hidden Markov Model}
%	\item[HTK] \emph{Hidden Markov Model Toolkit}
%	\item[IBGE] Instituto Brasileiro de Geografia Estatística
...
%	\item[PT\_BR] Português Brasileiro 
