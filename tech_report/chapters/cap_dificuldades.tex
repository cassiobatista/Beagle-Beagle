...
\begin{enumerate}
\item O Ångström é o sistema operacional de fábrica da BeagleBone Black,
bastante referenciado em fóruns e candidato principal para ser a base do
projeto. Entretanto, o sistema e a nomenclatura de pacotes não correspondiam com
os usados nas distribuições Debian, o que impossibilitava a instalação das
...
Com isso, pode-se observar que a frequência de amostragem seria 4 vezes menor
que a desejada. 
