...
tabela entitulada ``TV'' têm os atributos ``marca'' e os campos dos comandos
a serem transmitidos ao aparelho: ``volume+'', ``volume-'', ``canal+'',
``canal-'', ``ligar'', ``desligar'', ``endereço'', ``start''. Com isso,
