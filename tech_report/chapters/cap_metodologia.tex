...
passo. 
%Ångstr\"{o}m~\cite{angstrom} é um sistema operacional, baseado em Linux,
%preparado exclusivamente para plataformas embarcadas, sendo o padrão para a 
%própria BeagleBone. 
As dependências a serem instaladas são listadas na Lista~\ref{lst:dependences}.
...
\noindent
\textcolor{red}{*Predro: Detalhes da modelagem do DB*}
\end{section}
%%% EOF %%%
