...
\noindent
\textcolor{red}{$\downarrow$ Thiago: LIRC $\downarrow$ Gabriel: IR theory $\downarrow$ References + Figures + Tables $\downarrow$} 
...
a frequência dos pulsos oscila entre 32~kHz e 40~kHz, chegando a 50~kHz em
determinados aparelhos mais modernos. Além disso, a disponibilização de
documentação pelos fabricantes é muito rara. 

Neste trabalho, será aborado o protocolo RC-5, desenvolvido pela Philips. O
protocolo teve sua última documentação liberada em 1992, quando não existiam
home theaters, DVDs e outra vasta gama de dispositivos eletrônicos modernos
remotamente controlados. MAS EU ESPERO QUE FUNCIONE NESSA TV DE JESUS.

\begin{figure}[!h]
	\centering
	\includegraphics[width=.85\textwidth]{Figures/sch_rc5}
...
Smart Control}, o qual possui em seu ``pacote'' um aplicativo para iOS e Android
(porém sem versão para tablets; somente smartphones), um hub e um controle
remoto genérico. Segundo o review da cnet, vale a pena pagar US\$ 130 por todas
as funcionalidades que o sistema apresenta, como usar uma conexão RF entre o
smartphone/controle com o hub (que, infelizmente, ainda não conseguiu se livrar
do tão antiquado IR), o que faz com que o usuário não precise apontar o controle
para o dispositivo que precisa controlar. Todavia, o hub precisa estar numa boa
posição para conseguir emitir a informação de forma clara para o aparelho 
desejado.

IRdroid é outro aplicativo que permite o controle de aparelhos televisivos com o
celular. Como o próprio nome sugere, funciona apenas em dispositivos Android,
desde que seu módulo de hardware esteja acoplado na saída de audio jack do
smartphone. Versões mais recentes já possuem o hardware que pode ser acessado
via bluetooth, custando US\$ 60 o mais caro. A grande vantagem é que o IRdroid,
além de ser baseado na biblioteca LIRC, a qual possui uma vasta quantidade de
equipamentos em seu banco de dados, possui código livre e disponível.

Há também o projeto Google TV Remote, porém este é limitado apenas ao controle 
de uma Google TV.

Nenhuma das soluções possui suporte à reconhecimento e síntese de voz offline em
PT\_BR. CHUPA!!!
\end{section}
%%% EOF %%%
