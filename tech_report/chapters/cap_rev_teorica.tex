...
nível alto é gerado por um PWM de \textit{duty cycle} igual a 25\% do período do
pulso. Essa percentagem define o tempo em que o IR LED permanece aceso, ou seja,
no nível alto, o IR LED permanece ligado por período de $0,25\times1/36000~s$ e
desligado por $0,75\times1/36000~s$, sendo o processo repetido 32 vezes. A
economia de energia é mostrada como justificativa para explicar o motivo de o
led piscar ao invés de se manter aceso por 100\% do período do pulso.
