...
\textit{custom} bits cada; outras duas sessões de 8 bits definem o bloco de
dado, onde o segundo bloco é o complemento dos bits do primeiro, o qual define
os dados propriamente ditos; o 34$\degree$ e último bit é sempre baixo e encerra
o comando.
