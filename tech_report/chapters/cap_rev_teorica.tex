...
BeagleBone, a qual utilizava o pacote OpenCV para contar quantos indivíduos
...
um módulo GSM à BBB. A desvantagem é que, apesar de o controle poder ser
executado não necessariamente por um \textit{smartphone}, além de necessitar de
um cartão SIM para fazer a comuncação via SMS funcionar, os comandos de voz não
