...
\begin{lstlisting}[language=c, caption={db on c general structure}, label={lst:dbphi1}]
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <my_global.h>
...
Esta fun\c{c}\~{a}o tem como finalidade inserir o valor de um atributo da tabela, ela recebe o atributo 
