...
// gcc -o mine mine.cpp -I/usr/include/espeak/ -lespeak -std=gnu99
...
int main() {
	...
	strcpy(voicename, "pt-br");
	// espeak --voices
	//strcpy(voicename, "german");
	strcpy(voicename, GetLanguageVoiceName("pt-br"));
	
	if(espeak_SetVoiceByName(voicename) != EE_OK)
		printf("Espeak setvoice error...\n");
	
	static char word[100] = "Canal selecionado: 58" ;
	int speed = 170;
